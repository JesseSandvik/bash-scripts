...
ZSH_THEME_GIT_PROMPT_PREFIX="%{$fg_bold[black]%}[ %{$fg_bold[black]%}%{$fg_bold[black]%}"
...
_PATH="%{$fg_bold[black]%}%~%{$fg[black]%}"

_USERNAME="@%m";

_LIBERTY="%{$fg[cyan]%}>"
# _USERNAME="$_USERNAME%{$reset_color%}@%m"
# _USERNAME="[%{$fg_bold[black]%}%{$fg_bold[black]%}@%m"
...
_1LEFT_PREFIX="%{$fg_bold[black]%}---[ %{$fg_bold[black]%}%{$fg_bold[black]%}";
_1LEFT_SUFFIX="%{$fg_bold[black]%} ]------------";

_1LEFT="$_1LEFT_PREFIX$_USERNAME $_PATH$_1LEFT_SUFFIX";
_1RIGHT="[%*]"
